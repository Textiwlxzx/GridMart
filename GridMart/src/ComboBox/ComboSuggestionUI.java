...
public class ComboSuggestionUI extends BasicComboBoxUI {
    ...
    public void installUI(JComponent jc) {
        ...
        txt.setOpaque(false);
        txt.setBackground(new Color(217,217,217));
        txt.setBorder(new EmptyBorder(5, 8, 5, 8));
        comboBox.setOpaque(false);
        comboBox.setBorder(border);
        comboBox.setFont(new Font("Afacad", Font.PLAIN, 16));
        ...
        comboBox.addPopupMenuListener(new PopupMenuListener() {
            ...
            public void popupMenuWillBecomeVisible(PopupMenuEvent pme) {
                arrowButton.setBackground(new Color(54, 54, 54));
            }
