...
public class Essentials extends Product implements ExpirationDate, Serializable {
    
    private int daysLeft;
    
    public Essentials(String name, String description, double cost, double price, String cate, String path) {
        this(name, description, cost, price, "-", cate, path, "-", 0);
    }
    
    public Essentials(String name, String description, double cost, double price, String exp, String cate, String path) {
        this(name, description, cost, price, exp, cate, path, "-", 0);
    }
    
    public Essentials(String name, String description, double cost, double price, String exp, String cate, String path, String lot, int quantity) {
        this.name = name;
