...
public class Cashlist extends javax.swing.JPanel {
    
    public Cashlist() {
        initComponents();
    }
    
    public Cashlist(String name, int quantity) {
        initComponents();
        setOpaque(false);
        l_name.setText(name);
    ...
    private void initComponents() {
        ...
        panel1Layout.setHorizontalGroup(
            ...
            .addGroup(panel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(l_name, javax.swing.GroupLayout.DEFAULT_SIZE, 406, Short.MAX_VALUE)
