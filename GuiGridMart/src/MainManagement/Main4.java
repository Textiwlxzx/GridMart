...
public class Main4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rectangleBorder1.setPreferredSize(new java.awt.Dimension(536, 707));

        labelText1.setText("#OrderNo.");

        labelText6.setText("Receipt");
        labelText6.setFont(new java.awt.Font("Afacad", 0, 32)); // NOI18N
